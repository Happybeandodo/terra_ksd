...
sed -i 's/password_here/Qptmvlswldnjs_77/g' /var/www/html/wp-config.php
sed -i 's/localhost/mydb.c6ynnqyqvgkg.ap-northeast-2.rds.amazonaws.com/g' /var/www/html/wp-config.php
