...
mkdir /web
cd /web
wget /web https://downloads.apache.org/apr/apr-1.7.0.tar.gz
wget /web https://downloads.apache.org/apr/apr-util-1.6.1.tar.gz
wget /web https://downloads.apache.org/httpd/httpd-2.4.51.tar.gz
wget /web https://sourceforge.net/projects/pcre/files/pcre/8.45/pcre-8.45.tar.gz --no-check-certificate
